<template>
  ...
  >
    <div class="p-4 text-xs flex flex-col gap-4 tracking-normal">
      ...
      <p>Comet wallet is a cloned nautilus wallet, it's completly open source and fun made tool for interacting with the Ergo Blockchain.</p>
      <div>
      ...
      <p class="font-bold">
        This is a BETA and fun made version of Nautilus wallet, we recommend that you DO NOT use it to make large transactions or hold great amount of assets!
      </p>
              <a href="https://chrome.google.com/webstore/detail/nautilus-wallet/gjlmehlldlphhljhpnlddaodbjjcchai" target="_blank" class="url"
              >Official Nautilus Wallet</a>
